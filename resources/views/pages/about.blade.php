    ...
    <section class="hero" style="padding-top: 140px; padding-bottom: 60px;">
        <div class="container">
            <div style="background: white; border-radius: 16px; padding: 48px; border: 1px solid #e8e8e8; max-width: 900px; margin: 0 auto; text-align: left;">
                <h1 style="font-size: 32px; font-weight: 600; margin-bottom: 8px;">About BotPal</h1>
                ...
                <div style="color: #444; font-size: 15px; line-height: 1.7;">
                    ...
                    <p class="mb-4">At BotPal, we believe every business deserves access to cutting-edge AI technology to enhance their customer support. Our mission is to make it incredibly simple for businesses of all sizes to create intelligent, personalized chatbots that actually understand their customers.</p>

                    <hr style="border-color: #e8e8e8; margin: 24px 0;">

                    <h3 style="font-size: 18px; font-weight: 600; margin-bottom: 12px;">What We Do</h3>
                    <p class="mb-3">BotPal is an AI-powered chatbot platform that helps businesses:</p>
                    ...
                    <p class="mb-3">Powered by the latest GPT models, BotPal offers:</p>
                    <ul style="margin-left: 20px; margin-bottom: 20px;">
                    ...
                    <p class="mb-4">BotPal was founded by a team passionate about making AI accessible to everyone. After seeing countless small businesses struggle with overwhelming customer support demands, we set out to create a solution that's both powerful and easy to use. Today, BotPal serves thousands of businesses worldwide, helping them provide exceptional customer experiences.</p>

                    <hr style="border-color: #e8e8e8; margin: 24px 0;">

                    <h3 style="font-size: 18px; font-weight: 600; margin-bottom: 12px;">Why Choose BotPal?</h3>
                    <ul style="margin-left: 20px; margin-bottom: 20px;">
